...
try:
    ...
    print("错误: 找不到 local_account_config.py")
    print("请复制 local_account_config.example.py 为 local_account_config.py，并根据当前平台配置坐标。")
    sys.exit(1)
...
def save_exported_data():
    ...
    try:
        ...
        print("10 秒内未检测到导出完成弹框，跳过确认，继续后续同步...")
...
# 2. 配置 local_account_config.py 中的坐标
# 3. 运行脚本: python account_export.py
# ======================================
