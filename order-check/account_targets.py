...
配置说明：
  ...
  - position_ratio: 该目标账户的持仓同步比例，可选，默认使用 run_pipeline.py 的 --ratio 参数
...
示例：
    ACCOUNT_TARGETS = {
        ...
        "zhouzhou": [
            {"env_name": "simu", "user_id": "17883", "password": "123456"},
        ],
    }
"""
...
ACCOUNT_TARGETS = {
    ...
    # ],
    "wangxy0617": [
        {"env_name": "online", "user_id": "yqj0929", "password": "041354"},
    ],
    "wangk0402": [
        {"env_name": "online", "user_id": "sxk0812", "password": "sxk123456"},
    ],
    "wangk0402":[
        {"env_name": "online", "user_id": "yq02", "password": "yq123456"},
    ]
}
